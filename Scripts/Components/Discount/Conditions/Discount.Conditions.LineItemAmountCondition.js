...
Magelia.WebStore.Discount.Conditions.LineItemAmountCondition = function (editor, model) {
    this.editor = editor;
    this.initialize(model);
};

Magelia.WebStore.Discount.Conditions.LineItemAmountCondition.prototype = {
    identifier: 'lineitemamount',
