...
Magelia.WebStore.Discount.Conditions.CustomerCreationDateCondition = function (editor, model) {
    this.editor = editor;
    this.initialize(model);
};

Magelia.WebStore.Discount.Conditions.CustomerCreationDateCondition.prototype = {
    identifier: 'customercreationdate',
    template: 'CustomerCreationDateConditionEditor',
    category: 'user',
