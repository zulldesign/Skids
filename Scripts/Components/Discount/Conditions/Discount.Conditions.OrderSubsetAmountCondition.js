...
Magelia.WebStore.Discount.Conditions.OrderSubsetAmountCondition = function (editor, model) {
    this.editor = editor;
    this.initialize(model);
};

Magelia.WebStore.Discount.Conditions.OrderSubsetAmountCondition.prototype = {
    identifier: 'ordersubsetamount',
    ...
    initialize: function (model) {
        ...
        this.currentIncludeShipping = false;
    ...
    updateCurrentIncludeShipping: function (includeShipping) {
        this.currentIncludeShipping = includeShipping;
    },
    ...
    addValue: function () {
        ...
        this.model.Values.push({ Minimum: this.currentMinimum, Maximum: this.currentMaximum, IncludeTaxes: this.currentIncludeTaxes, IncludeDiscount: this.currentIncludeDiscount, IncludeShipping: this.currentIncludeShipping, CurrencyId: this.currentCurrencyId });
        this.sortValues();
        this.currentMinimum = null;
        this.currentMaximum = null;
        this.currentIncludeTaxes = false;
    ...
    editValue: function (index) {
        ...
        this.currentIncludeShipping = value.IncludeShipping;
