<%@ Page Title="" Language="C#" MasterPageFile="~/App_Masters/DefaultLayout.Master"
    AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Magelia.WebStore.Admin.Products.Brands.List" %>

<asp:Content ContentPlaceHolderID="cphBarTitle" runat="server">
    <asp:Literal ID="litBrands" runat="server" meta:resourcekey="litBrands" />
</asp:Content>
<asp:Content ContentPlaceHolderID="cphBarContent" runat="server">
    <ul>
        <mag:FeaturePanel runat="server" Level="CreateAndDelete" Tag="Li">
            <asp:HyperLink runat="server" NavigateUrl="~/Products/Brands/Edit.aspx" Text='<%$ resources:global, AddNew %>'
                SkinID="Major" />
        </mag:FeaturePanel>
    </ul>
</asp:Content>
<asp:Content ContentPlaceHolderID="cphBody" runat="server">
    ...
    <mag:Gridview ID="mgvBrands" runat="server" ShowSelectionColumn="true" DataKeyNames="BrandId"
        OnCommand="mgvBrands_Command">
        <commandbuttons>
            <mag:CommandButton runat="server" Text='<%$ resources:global, Delete %>' CommandName="DeleteBrands"
        ...
        <columns>
            ...
            <mag:GridViewColumn ID="mgvcLogo" runat="server" AllowSorting="true" SortExpression="LogoUrl"
                ...
                <celltemplate>
                    <asp:Image  runat="server" AlternateText='<%# Eval("LogoAlternateText") %>' ToolTip='<%# Eval("LogoTitle")  %>' Visible='<%# !String.IsNullOrEmpty(((Magelia.WebStore.Admin.Products.Brands.List.BrandViewModel)Container.DataItem).LogoUrl) %>' ImageUrl='<%# Eval("LogoUrl") %>' />
                </celltemplate>
            </mag:GridViewColumn>
            <mag:GridViewColumn runat="server" AllowSorting="false" Name='<%$ resources:global, Action %>'>
                <celltemplate>
                    <ul>
                        <li>
                            <asp:ImageButton runat="server" CommandName="EditBrand" SkinID="Edit" ToolTip='<%$ resources:global,Edit %>' />
                        </li>
                        <mag:FeaturePanel runat="server" Level="CreateAndDelete" Tag="Li">
                            <asp:ImageButton runat="server" CommandName="DeleteBrands" SkinID="Delete" ToolTip='<%$ resources:global,Delete %>'  OnClientClick='<%$ resources:global, ClientClickConfirmDeletion %>'/>
                        </mag:FeaturePanel>
                    </ul>
                </celltemplate>
            </mag:GridViewColumn>
